...
<?php do_action( 'lawyer_lite_page_header' ); ?>

<main role="main" id="maincontent" class="middle-align">
    <div class="container">
        <?php
        $lawyer_lite_left_right = get_theme_mod( 'lawyer_lite_single_page_sidebar_layout','One Column');
...
<?php do_action( 'lawyer_lite_page_footer' ); ?>
